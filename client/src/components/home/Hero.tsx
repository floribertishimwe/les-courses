  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
    <div className="max-w-xl xl:pl-10">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Link 
          to={"/products"} 
          className="group px-7 py-3 bg-orange-400 text-white font-semibold rounded-full hover:bg-orange-500 transition-all flex items-center justify-center gap-2 active:scale-[0.98]"
        >
          Shop Now  
          <ArrowRightIcon className="size-4 transition-transform duration-200 ease-in-out group-hover:translate-x-1" />
        </Link>
        <Link 
          to={"/products"} 
          className="group px-7 py-3 bg-white/10 text-white font-semibold rounded-full hover:bg-white/20 transition-all flex items-center justify-center gap-2 border border-white/20 active:scale-[0.98]"
        >
          Browse Categories
          <ArrowRightIcon className="size-4 transition-transform duration-200 ease-in-out group-hover:translate-x-1" />
        </Link>
