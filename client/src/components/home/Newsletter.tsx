...
const Newsletter = () => {
  return (
    <section className="bg-white py-18 px-4  sm:px-8 rounded-3xl mx-auto  shadow-xs mt-32 mb-20">
        <div  className="max-w-2xl mx-auto text-center">
            ...
            <p className=" text-shadow-app-light mb-8  text-base "> 
            Get weekly updates on the  fresh produce, seasonal offers and exclusive discounts right to your inbox.</p>
            <form  onSubmit={(e)=> e.preventDefault() } className=" flex flex-col  sm:flex-row gap-3 max-w-md mx-auto">
                ...
                <button  type="submit" className="px-8 py-3.5 bg-app-green text-white font-semibold rounded-xl hover:bg-app-green-light
