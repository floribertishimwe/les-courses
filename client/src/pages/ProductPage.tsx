          ...
          <div className=" grid  md:grid-cols-2 gap-0 ">
            ...
            <div className=" p-6 md:p-10 flex flex-col justify-center">
              ...
              <p className="text-sm  text-app-text-light leading-relaxed mb-6">{product.description}</p>
                ...
                <div className=" mb-6 ">
                  { product.stock > 0 ? (
                    <span className="text-sm text-app-success">✓ In Stock ({product.stock} available)</span>
                  ):(
                ...
                <div className="flex items-center gap-3">
                  {/* Quantity */}
                  <div className="flex items-center border border-app-boder rounded-xl overflow-hidden">
                  ...
                  <button
                   ...
                   disabled={product.stock === 0}  className={` flex-1 py-3  font-semibold rounded-xl
                    transition-colors flex-center gap-2 disabled:cursor-not-allowed
