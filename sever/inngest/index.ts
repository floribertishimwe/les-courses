...
const LOW_STOCK_TRESHOLD = 10;

// Create a client to send and receive events
export const inngest = new Inngest({ id: "glocery-delivery"});

// Low stock alert to Admin Email
const checkLowerStock = inngest.createFunction(
  { id: "check-low-stock",
  ...
  async ({ event, step }) => {
    ...
    if (!product || product.stock === null || product.stock >= LOW_STOCK_TRESHOLD ){
